...
- [1. Summary](#summary)
- [2. Features Selection / Extraction](#features-selection-extraction)
- [3. Modeling Techniques and Training](#modeling-techniques-and-training)
	- [3.1 Modelling](#modelling)
	- [3.2 Training](#training)
	- [3.3 Ensembling](#ensembling)
- [4. Code Description](#code-description)
- [5. Dependencies](#dependencies)
- [6. How To Generate the Solution (aka README file)](#how-to-generate-the-solution-aka-readme-file)
	- [6.1 Hardware / OS](#hardware-os)
	- [6.2 Installing Dependencies](#installing-dependencies)
	- [6.3 How to recreate test data.](#how-to-recreate-test-data)
	- [6.4 Making predictions on new data](#making-predictions-on-new-data)
- [7. Additional Comments and Observations](#additional-comments-and-observations)
	- [7.1 EEG features](#eeg-features)
	- [7.2 Whitening and LDA classifier](#whitening-and-lda-classifier)
	- [7.3  PCA, SVD, ICA](#pca-svd-ica)
	- [7.4 Ideas that were tried and abandoned](#ideas-that-were-tried-and-abandoned)
- [8. Simple Features and Methods](#simple-features-and-methods)
- [9. Figures](#figures)
